...
def register():
    if request.method == 'POST':
        ...
        try:
            ...
            flash(f'There was an issue with registration: {str(e)}')
            return redirect(url_for('register'))
...
def doctor_profile(doctor_id):
    ...
    # Pass current date to the template for today's appointments
    from datetime import date
    return render_template('profiles/doctor_profile.html', doctor=doctor, current_date=date.today())
